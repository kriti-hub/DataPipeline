...
ORDER BY region, regional_rank;`,
    ...
    sampleRows: [
      { location_name: "HCRochester 5", region: "Northeast", location_type: "Suburban", avg_coverage: "0.998", total_overtime: "145.2", avg_cost_per_visit: "$41.20", efficiency_tier: "Optimal", regional_rank: "1" },
      { location_name: "HCBuffalo 10", region: "Northeast", location_type: "Suburban", avg_coverage: "0.994", total_overtime: "158.7", avg_cost_per_visit: "$42.10", efficiency_tier: "Optimal", regional_rank: "2" },
      { location_name: "HCHartford 31", region: "Northeast", location_type: "Suburban", avg_coverage: "1.406", total_overtime: "89.3", avg_cost_per_visit: "$38.50", efficiency_tier: "Optimal", regional_rank: "3" },
      { location_name: "HCPhiladelphia 25", region: "Northeast", location_type: "Urban", avg_coverage: "0.857", total_overtime: "1969.0", avg_cost_per_visit: "$52.40", efficiency_tier: "Understaffed", regional_rank: "35" },
    ],
...
ORDER BY deploy_priority;`,
    ...
    sampleRows: [
      { deploy_priority: "1", location_name: "HCNew York City 12", region: "Northeast", total_gaps_30d: "94", avg_gap_pct: "12.3%", recommendation: "Deploy float ASAP" },
      { deploy_priority: "2", location_name: "HCRichmond 68", region: "Southeast", total_gaps_30d: "89", avg_gap_pct: "11.8%", recommendation: "Deploy float ASAP" },
      { deploy_priority: "3", location_name: "HCPhiladelphia 25", region: "Northeast", total_gaps_30d: "86", avg_gap_pct: "11.2%", recommendation: "Deploy float ASAP" },
      { deploy_priority: "4", location_name: "HCOrlando 74", region: "Southeast", total_gaps_30d: "82", avg_gap_pct: "10.9%", recommendation: "Deploy float ASAP" },
    ],
...
LIMIT 15;`,
    ...
    sampleRows: [
      { location_name: "HCNew York City 12", region: "Northeast", total_ot_hours: "2,564.7", est_ot_cost: "$192,353", avg_cpv: "$54.20", cumulative_cost: "$192,353", cumulative_pct: "11.2%" },
      { location_name: "HCRichmond 68", region: "Southeast", total_ot_hours: "1,990.2", est_ot_cost: "$149,265", avg_cpv: "$51.80", cumulative_cost: "$341,618", cumulative_pct: "19.8%" },
      { location_name: "HCPhiladelphia 25", region: "Northeast", total_ot_hours: "1,969.0", est_ot_cost: "$147,675", avg_cpv: "$52.40", cumulative_cost: "$489,293", cumulative_pct: "28.4%" },
      { location_name: "HCBoston 34", region: "Northeast", total_ot_hours: "1,819.4", est_ot_cost: "$136,455", avg_cpv: "$50.90", cumulative_cost: "$761,998", cumulative_pct: "44.2%" },
    ],
